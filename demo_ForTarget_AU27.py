...
def main(args):
    ...
    for i in tqdm(range(1,len(testdata)-1)):
        ...
        rects_2 = plt.barh(["AU1", "AU2", "AU4", "AU5", "AU6","AU7", "AU9","AU10","AU11",
                 "AU12", "AU13","AU14","AU15","AU16", "AU17", "AU18","AU19",
                 "AU20","AU22","AU23","AU24", "AU25", "AU26","AU27","AU32","AU38","AU39"],
        ...
        plt.xlim((0, 1))
        add_labels(rects_2)
        plt.savefig(os.path.join(savefolder, 'result', name + '_AU.jpg'))
        ...
        plt.xlim((0,1))
        add_labels(rects_2)
        plt.savefig(os.path.join(savefolder, 'result', name + '_Emotion.jpg'))
        ...
        v = cv2.vconcat([vis_image[:, :448], vis_image[:, 448 * 4:448 * 5],
                         cv2.resize(cv2.imread(os.path.join(savefolder, name + '_Emotion.jpg'))[20:-20, 20:-20], [448, 448],
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-i', '--inputpath', default="/home/cine/Desktop/ForSeuqenceFrames/Left01/2685_2712/",
    ...
    parser.add_argument('-s', '--savefolder',
                        default='/home/cine/Documents/ForPaperResult/TestReult_New0420/AULoss/sequence_pretrain6/ForCheck_DISFA/',
