...
def main(args):
    ...
    testdata = datasets.TestData(args.inputpath, type= "image",iscrop=args.iscrop, crop_size=deca_cfg.dataset.image_size,
                                 scale=1.15, )
    os.makedirs(os.path.split(args.inputpath.replace("images","croppedImages"))[0],exist_ok=True)
    ...
    for i in tqdm(range(0, len(testdata))):
        ...
        cropPath = imagepath.replace("images", "croppedImages")
...
if __name__ == '__main__':
    ...
    # name = 'Actor_02angry'  # angry, calm, disgust, fear, happy, neutr, sad, surprise
    ...
    # parser.add_argument('-i', '--inputpath', default='/home/cine/Downloads/actors/croppedImage/' + name, type=str,
    parser.add_argument('-i', '--inputpath', default='/home/cine/Downloads/AFLW2000-3D/AFLW2000/images/*.jpg', type=str,
    ...
    parser.add_argument('-s', '--savefolder', default='TestReult/AFLW2000-3D/pretrain4',
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        default='/media/cine/First/HJCode2/AUSequence/Training1_videoC_OnlyE/pretrain4/model.tar', type=str,
                        help='model.tar path')
