...
from decalib.models.OpenGraphAU.conf_DISFA import get_config,set_logger,set_outdir,set_env
    ...
    for videopath in allVideos:
        # for k in range(len(actors)):
            ...
            for i in tqdm(range(0, len(testdata) - 1)):
                ...
                rend_au_deca,_ = AU_net(opdict['rendered_images_deca'])
                # update_list = statistics(image_au, rend_au, 0.5)
