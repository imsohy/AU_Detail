...
from decalib.gatfarec_Video_Part import DECA
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='TestReult/pretrain3_X/' + name + '_texture2/',
                        type=str,
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        default='/home/cine/Documents/HJCode/AU_sequence/Training1_videoC_Part/pretrain2/model.tar', type=str,
                        help='model.tar path')
