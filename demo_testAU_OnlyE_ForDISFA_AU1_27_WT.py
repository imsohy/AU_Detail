    ...
    for videopath in allVideos:
        # for k in range(len(actors)):
            ...
            for i in tqdm(range(half, len(testdata) - half)):
                idxs = range(i - half, i + half + 1)  # i-3 .. i+3
                frames = [testdata[j]['image'][None, ...] for j in idxs]
                ...
                image_au = AU_net(images[half:half+1])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder',
                        ...
                        default='/media/cine/First/HWPJ2/PAPER_DISFA/*/',
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        ...
                        default='/media/cine/First/HWPJ2/ProjectResult/DetailNew/model.tar',
