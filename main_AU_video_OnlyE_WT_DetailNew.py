...
from decalib.trainer_Video_OnlyExpress_WT_DetailNew import Trainer
...
if __name__ == '__main__':
    ...
    cfg = parse_args(cfg_name='configs/release_version/deca_pretrain_video_OnlyE2_WT_DetailNew.yml')
