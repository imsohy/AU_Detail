...
def main():
    ...
    parser.add_argument('--input_folder', type=str, default="/home/cine/Desktop/DataForEV/Actor01_angry")
    ...
    # 2) Create a dataset
    dataset = TestData(input_folder,iscrop=False, face_detector="fan", max_detection=20)
