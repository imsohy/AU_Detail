...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='/media/cine/First/HWPJ2/ProjectResult/Demos/DetailNew_PT50_Demo/' + name,
                        type=str,
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        default='/media/cine/First/HWPJ2/ProjectResult/DetailNewBranch_PT50/model.tar', type=str,
                        help='model.tar path')
