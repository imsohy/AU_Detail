...
def main(args):
    ...
    # for i in tqdm(range(1,2)):
        ...
        plt.xlim((0, 1))
        add_labels(rects_2)
        plt.savefig(os.path.join(savefolder, name + '_AU.jpg'))
        ...
        plt.xlim((0,1))
        add_labels(rects_2)
        plt.savefig(os.path.join(savefolder,  name + '_Emotion.jpg'))
        ...
        v = cv2.vconcat([vis_image[:,:448],vis_image[:,448*4:448*5],cv2.resize(cv2.imread(os.path.join(savefolder, name + '_AU.jpg'))[20:-20,20:-20],[448, 448], interpolation=cv2.INTER_NEAREST)])
