...
def main(args):
    ...
    out = cv2.VideoWriter(os.path.join(savefolder, args.vidoname + ".mp4"), fourcc, 30, (448 * 3, 448 * 3), True)
    # run DECA
...
if __name__ == '__main__':
    ...
    # # 08, 30, 37, 43, 64, 75
    name = 'Actor_18angry'  # angry, calm, disgust, fear, happy, neutr, sad, surprise
    ...
    parser.add_argument('-s', '--savefolder', default='/media/cine/First/HWPJ2/ProjectResult/DetailNewDemo/' + name,
                        type=str,
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        default='/media/cine/First/HWPJ2/ProjectResult/DetailNew/model.tar', type=str,
                        help='model.tar path')
