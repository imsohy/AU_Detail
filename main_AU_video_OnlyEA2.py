...
def main(cfg):
    ...
    # else:
    from decalib.gatfarec_Video_OnlyExpressA import DECA
    from decalib.trainer_Video_OnlyExpressA import Trainer
    cfg.rasterizer_type = 'pytorch3d'
    cfg.device = 'cuda:1'
    mymodel = DECA(cfg)
...
if __name__ == '__main__':
    ...
    cfg = parse_args(cfg_name='configs/release_version/deca_pretrain_video_OnlyEA2.yml')
