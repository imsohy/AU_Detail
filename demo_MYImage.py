...
if __name__ == '__main__':
    ...
    name = 'My4'  # (02) angry, (x) calm, (10) disgust, (x) fear, (14)happy, neutr, (3) sad, (18)18surprise
    ...
    parser.add_argument('-i', '--inputpath', default='/home/cine/Desktop/MyVideo/4', type=str,
    ...
    parser.add_argument('-s', '--savefolder', default='/home/cine/Desktop/MyVideo_TestReult/' + name + '_texture/',
