...
from decalib.gatfarec_Video_OnlyExpress_WT import DECA
from decalib.datasets import datasets2 as datasets
from decalib.utils import util
from decalib.utils.config_wt import cfg as deca_cfg
...
def main(args):
    ...
    K = 11  # 원하는 윈도우 크기 (반드시 홀수여야 함: 3, 5, 7 ...)
    half = K // 2

    for i in tqdm(range(half, len(testdata) - half)):
        # 중심 프레임 기준으로 앞뒤 half 만큼 포함
        frames = [testdata[i + j]['image'][None, ...] for j in range(-half, half + 1)]
...
if __name__ == '__main__':
    ...
    # # 08, 30, 37, 43, 64, 75
    name = 'Actor_03happy'  # angry, calm, disgust, fear, happy, neutr, sad, surprise
    ...
    parser.add_argument('-s', '--savefolder', default='/home/cine/Documents/HWPJ/windowTest/win11Test/' + name + '_texture2/',
                        type=str,
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        default='/home/cine/Documents/HWPJ/windowTest/win11/model.tar', type=str,
                        help='model.tar path')
