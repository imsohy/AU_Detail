...
def main(args):
    ...
    out = cv2.VideoWriter(os.path.join(savefolder, args.vidoname + ".mp4"), fourcc, 30, (448 * 6, 448), True)
    # run DECA
    ...
    for i in tqdm(range(1, len(testdata)-1)):
        ...
        with torch.no_grad():
            ...
            if args.render_orig:
                ...
                _, orig_visdict = deca.decode(codedict, codedict_old, render_orig=True, original_image=original_image, tform=tform)
...
if __name__ == '__main__':
    ...
    # name = 'Actor_18surprise'  # (02) angry, (x) calm, (10) disgust, (x) fear, (14)happy, neutr, (3) sad, (18)18surprise
    name = '92-24-1920x1080'  # (02) angry, (x) calm, (10) disgust, (x) fear, (14)happy, neutr, (3) sad, (18)18surprise
    ...
    # parser.add_argument('-i', '--inputpath', default='/home/cine/Downloads/actors/images/' + name, type=str,
    parser.add_argument('-i', '--inputpath', default='/media/cine/First/Aff-wild2/images/92-24-1920x1080_sequence/*/*.*', type=str,
    ...
    # parser.add_argument('-s', '--savefolder', default='TestReult/OnlyE/pretrain1_/' + name + '_texture2/',
    parser.add_argument('-s', '--savefolder', default='/home/cine/Documents/ForPaperResult/TestReult/FigureMade/' + name + '_texture/',
    ...
    parser.add_argument('--pretrained_modelpath_ViT',
                        # default='/home/cine/Documents/HJCode/AU_sequence/Training1_videoC_OnlyE/pretrain1/models/00820199.tar', type=str,
