...
from decalib.gatfarec_Video_DetailNewBranch_v2 import DECA
from decalib.trainer_Video_DetailNewBranch_decodertrain_v2 import Trainer
...
if __name__ == '__main__':
    from decalib.utils.config_wt_DetailNew import parse_args
    cfg = parse_args(cfg_name='configs/release_version/deca_pretrain_DetailNewBranch.yml')
