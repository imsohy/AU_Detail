...
class DECA(nn.Module):
    ...
    def decode(self, codedict, codedict_old, rendering=True, iddict=None, vis_lmk=True, vis_au=False, return_vis=True,
        ...
        if rendering:
            ...
            uv_z_old = self.D_detail_original(cond_old).to(self.device)  # Use frozen original decoder
            ...
            if iddict is not None:
                ...
                uv_z_old = self.D_detail_original(cond_old_id).to(self.device)  # Use frozen original decoder
