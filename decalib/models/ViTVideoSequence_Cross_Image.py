...
class ViT(nn.Module):
    def __init__(self, *, num_classes, dim, depth, heads, mlp_dim, patch_dim = 512, pool = 'cls', channels = 1, dim_head = 64, dropout = 0., emb_dropout = 0., layer = 9):
        super().__init__()
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, 28, dim))
    ...
    def forward(self, feature, global_feature,layers = 14):
        ...
        b,n,_ = x.shape
        y = self.FC_glob(global_feature).view(b,1,-1)
