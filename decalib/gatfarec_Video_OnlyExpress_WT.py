...
class DECA(nn.Module):
    ...
    def encode(self, images_224):
        ...
        parameters_224 = parameters_224[3:4]
        ...
        codedict['images'] = images_224[3:4]
        codedict_our['images'] = images_224[3:4]
    ...
    def decode(self, codedict,codedict_old, rendering=True, iddict=None, vis_lmk=True, vis_au=False, return_vis=True, use_detail=False, use_gnn=False,
        ...
        if return_vis:
            ...
            shape_images_full_old, shape_images_old, _, _, _ = self.render.render_shape(verts_old, trans_verts_old, h=h, w=w,
                                                                           images=background, return_grid=True)
