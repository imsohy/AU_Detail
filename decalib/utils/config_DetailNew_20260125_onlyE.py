...
2026 01 25: OnlyExpressionA 방식 - param_list_OnlyE = ['exp']로 변경
'''
...
# cfg.pretrained_modelpath = "./data/model_new.tar"
cfg.pretrained_modelpath_224 = os.path.join(abs_deca_dir, 'data', 'deca_model.tar')
cfg.pretrained_coarse_modelpath = ""  # Empty by default, set in yml if needed
...
cfg.model_path_HJ = ''
cfg.output_dir = '/home/cine/Documents/First/HWPJ2/ProjectResult/DetailNewDemo_basic/'
...
# OnlyExpressionA 방식: expression만 추론
...
cfg.train.train_decoder = True  # Decoder(D_detail) 학습 여부 (train_detail=True일 때만 의미 있음)
...
def parse_args(cfg_name=None):
    ...
    if cfg_name == None:
        ...
        parser.add_argument('--cfg', type=str, default='', help='cfg file path')
    else:
