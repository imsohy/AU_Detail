    ...
    def decode(self, codedict, codedict_old, rendering=True, iddict=None, vis_lmk=True, vis_au=False, return_vis=True,
        ...
        if rendering:
            ...
            if return_vis:
                ...
                # Sample detail texture to image space for render_images_old (Original DECA)
                predicted_detail_images_old = F.grid_sample(uv_texture_old, ops_old['grid'], align_corners=False)
                ...
                # Texture + coarse + detail (Original DECA with background)
                render_images_old = images * (1 - opdict['v_colors_old']) + predicted_detail_images_old * opdict['v_colors_old']
                ...
                visdict = {
                    ...
                    'render_images_old': render_images_old,  # Original DECA with background
