...
def main(args):
    ...
    # expressionNames = [ "surprised","neural", "calm"]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder',
                        ...
                        default='/media/cine/First/ForPaperResult_emoca_crop/TestReult_New0420/AULoss/sequence_pretrain6/Actor_id/exp_texture/',
